...
+ **tconst**: There are no missing values. There are exactly 1,549,046 id's (i.e. individual films), one for every row.
...
+ **primaryTitle**: There are no missing values. There are 1,145,048 primaryTitles in the dataset (< 1,549,046). This should be looked into.
+ **originalTitle**: There are no missing values. There are 1,162,999 originalTitles in the dataset (< 1,549,046 and > 1,145,048). This should be looked into.
...
+ **runtimeMinutes**: There are missing values! Ignoring missing values, the shortest film is 0 minute long, while the longest film is 3,692,080 minutes (61,534 hours 40 minutes) long. This longest runtime seems unusual. The average film length is around 58.59 minutes (0.9765 hours).
...
+ **job**: There are missing values — this is because of the duplicate values from the first column. There are 29,940 unique values within this column. 
+ **characters**: There are missing values — this is because of the duplicate values from the first column. There are 2,486,921 unique values within this column. 
...
+ **numVotes**: There are no missing values. Of all 1,549,046 films, 37756 films have received the lowest number of reviews (only 5 reviews). Of all 1,549,046 films, only one film (i.e. the film in the 84,693rd row) has the largest number of reviews (3,021,924 reviews).
